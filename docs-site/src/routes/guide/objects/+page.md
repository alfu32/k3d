...
- Actions toolbar: `Create Object`, `Edit Selected Object`, `Close Object`, and `Explode Object` are available as single-click controls for touch-friendly workflows.
